...
enum TASK_API_ID
{
    ...
    TASK_ID_OTA           = 66,   // OTA Task

    TASK_ID_VOICEPATH    = 67,   // Voice Path Task
    TASK_ID_ANCC         = 68,   // ANCS Client Task

    TASK_ID_AMSC         = 69,   // AMS Client Task

    TASK_ID_BMS          = 70,   // BMS Task
	TASK_ID_GFPSP         = 71,   //google fast pair service provider
	TASK_ID_GFPSS         = 72,   // seeker 
    TASK_ID_ANCSP        = 73,   // ANCS Proxy Task
