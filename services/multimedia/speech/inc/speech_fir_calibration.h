...
#define speech_fir_calib_init CONSTRUCT_FUNC_NAME(speech, FIR_IMPL, calib_init)
#define speech_fir_calib_destroy CONSTRUCT_FUNC_NAME(speech, FIR_IMPL, calib_destroy)
#define speech_fir_calib_process CONSTRUCT_FUNC_NAME(speech, FIR_IMPL, calib_process)
