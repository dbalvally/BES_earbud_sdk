...
#define VAD_DEFAULT_FRAME_LEN   0x50
#define VAD_DEFAULT_MVAD        0x7
#define VAD_DEFAULT_DIG_MODE    0x0
#define VAD_DEFAULT_PRE_GAIN    0x4
#define VAD_DEFAULT_STH         0x20
 ...
 *     continous:
 *       1: This function will not return until the VOICE_DET_EXIT_CMD be sent
